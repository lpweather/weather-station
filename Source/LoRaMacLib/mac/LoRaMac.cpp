 ...
 */
Ticker ChannelCheckTimer;

/*!
 * LoRaMac duty cycle delayed Tx timer
 */
Ticker TxDelayedTimer;

/*!
 * LoRaMac reception windows timers
 */
Ticker RxWindowTimer1;
Ticker RxWindowTimer2;
...
static void OnRadioRxDone( uint8_t *payload, uint16_t size, int16_t rssi, int8_t snr )
{
    ...
    RxWindowTimer2.detach( ); // Timer is removed anyway in functions above
